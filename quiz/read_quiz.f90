...
CONTAINS
    SUBROUTINE read_questions(A1, A2)
        ...
        !Since the file is getting split into two arrays, the indices of each are operated on accordingly to make sure that the question/answer
        ...
        DO i = 1, num_lines
            ...
            ELSE
                READ(file_id, *) A2(i/2) !The format modifier, *, in this case indicates to read until first white space or end of line. It will type cast to int
            END IF
        END DO
